...
//以下三个flash分区定义需根据flash大小来更改定义
#define FATFS_FLASH_SIZE 12
#define FONT_FLASH_SIZE 2
#define USER_FLASH_SIZE 2
/***************Flash相关定义*******************/
//W25Q128 16M byte,256 block,每个block=16个扇区,每个扇区4096byte

//前FATFS_FLASH_SIZE给FATFS使用,6M~7M用户区,7M~9M,字库区

u16	FLASH_SECTOR_COUNT=2048*FATFS_FLASH_SIZE;//FATFS_FLASH_SIZE字节,默认为W25Q128
		...
		switch(drv)
		{
			...
			case EX_FLASH://外部Flash
				...
				if(SPI_FLASH_TYPE==W25Q128)
					FLASH_SECTOR_COUNT=2048*12;//12M字节,默认为W25Q128
				else
